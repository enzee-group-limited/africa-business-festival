...
const WhyUsSection = () => {
  return (
    <div className="bg-img flex justify-evenly  flex-col md:flex-row h-[15vh] sm:h-[10vh] md:h-[20vh] w-full">
      {/* Left Section */}
      <div className="flex justify-center items-center text-fontColors bg-bgColor   font-poppins font-extrabold text-4xl md:text-6xl flex-1">
        WHY US
      </div>
